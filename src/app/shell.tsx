...
function WorkspaceSidebar() {
  return <aside className="workspace-sidebar" aria-label="Workspace navigation"><nav><a>⌂&nbsp;&nbsp;My Work</a><a>◉&nbsp;&nbsp;Inbox</a><a className="active">▣&nbsp;&nbsp;Projects</a><a>◇&nbsp;&nbsp;Teams</a><a>≡&nbsp;&nbsp;Views</a><hr/><span className="nav-label">Favorites</span><a>Platform Core</a></nav></aside>;
}
export function AppShell({ children }: { children: ReactNode }) {
  return <div className="app-shell"><GlobalBar/><WorkspaceSidebar/><main className="app-content">{children}</main></div>;
}
