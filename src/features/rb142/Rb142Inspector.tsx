...
function StateLabel({ phase }: { phase: string }) {
  ...
  return (
    <span className={`mutation-state mutation-${phase}`} role="status">
      {phase === "pending"
        ? "Pending"
        : phase === "offline"
...
export function Rb142Inspector({ onClose }: { onClose: () => void }) {
  ...
  if (query.isLoading)
    return <aside className="work-inspector">Loading RB-142…</aside>;
  ...
  if (snapshot.unavailable)
    return (
      <aside className="work-inspector unavailable-panel">
  ...
  return (
    <aside
      className="work-inspector rb142-inspector"
    ...
    >
        ...
        <div className="property-list">
          <div>
            ...
            <button
              ...
              className="property-control capitalize"
            >
              {priorityDisplay}
            </button>
            <StateLabel phase={slice.priorityState.phase} />
          </div>
          {editor === "priority" && (
            <div
          ...
          <div>
            ...
            <StateLabel phase={slice.statusState.phase} />
          </div>
          {editor === "status" && (
            <div
              className="property-editor"
      ...
      <section className="inspector-section">
        ...
        <label className="comment-composer">
          ...
          />
          <div>
            <StateLabel phase={slice.commentState.phase} />
            <button
              type="button"
              disabled={
                draft !== RB142_COMMENT ||
