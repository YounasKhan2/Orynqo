...
const seed: readonly InboxNotification[] = [
  ...
  },
  {
    ...
    occurredAt: "2026-09-24T04:22:00.000Z",
    readAt: "2026-09-24T04:28:00.000Z",
    targetState: "accessible",
  },
  {
...
export class DevelopmentInboxRepository implements InboxRepository {
  ...
  async setRead(
    ...
    const next = {
      ...current,
      readAt: read ? "2026-09-24T05:00:00.000Z" : null,
    };
...
export const inboxRepository: InboxRepository =
  new DevelopmentInboxRepository();
