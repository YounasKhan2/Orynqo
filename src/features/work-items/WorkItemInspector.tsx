...
export function WorkItemInspector({
  ...
  if (query.isLoading)
    return (
      <aside className="work-inspector" aria-label="Loading Work Item">
        <div className="inspector-skeleton">Loading Work Item…</div>
      </aside>
    );
  if (query.isError || !query.data)
    return (
      <aside className="work-inspector" aria-label="Work Item">
  ...
  return (
    <aside className="work-inspector" aria-labelledby="inspector-title">
      ...
      <section className="inspector-section">
        <h3>Relationships</h3>
        <p className="muted">No linked items in this fixture.</p>
      </section>
      <section className="inspector-section">
        <h3>Comments</h3>
        <p className="muted">
